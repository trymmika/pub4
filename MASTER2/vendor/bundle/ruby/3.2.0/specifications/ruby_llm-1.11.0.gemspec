...
Gem::Specification.new do |s|
  ...
  s.post_install_message = "Upgrading from RubyLLM < 1.10.x? Check the upgrade guide for new features and migration instructions\n--> https://rubyllm.com/upgrading/\n".freeze
  ...
  s.add_runtime_dependency(%q<ruby_llm-schema>.freeze, ["~> 0.2.1"])
