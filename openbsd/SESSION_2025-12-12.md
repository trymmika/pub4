...
1. **G:\pub\openbsd\openbsd.sh** - 4 edits, ~150 lines changed
2. **G:\pub\openbsd\README.md** - Updated documentation
...
- Failed: brgen, amber (awaiting Rails code upload from G:\pub\rails)
...
Apps in `G:\pub\rails\` need deployment:
...
1. Review this session file: `G:\pub\openbsd\SESSION_2025-12-12.md`
...
- Host: 185.52.176.18
- User: dev
- Key: G:\priv\passwd\id_rsa
- SSH: `ssh -i G:\priv\passwd\id_rsa dev@185.52.176.18`
